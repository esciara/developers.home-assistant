...
- Create basic `SKILL.md descriptions`
...
- `SKILL.md descriptions` with one Skill's patterns
- Verified hooks run on prompt submit

**See:** [Hook System Setup](../architecture/overview.md#setup-process)
...
- Trigger patterns in `SKILL.md descriptions`
...
1. [Native Skill Activation](../architecture/overview.md)
2. [System Architecture Overview](../architecture/overview.md)

**Clone reference repo:**
```bash
# Study hook scripts and SKILL.md descriptions format
```
...
**1.3. Create basic SKILL.md descriptions:**
```bash
...
**2.6. Update SKILL.md descriptions:**
```json
{
  "ha-config-flow-knowledge": {
    "prompt_patterns": [
...
2. Verify SKILL.md descriptions syntax: cat SKILL.md descriptions | jq .
...
- [ ] SKILL.md descriptions created with valid JSON
...
- [ ] Trigger patterns defined in SKILL.md descriptions
...
2. Add trigger patterns to SKILL.md descriptions
...
2. **Pattern issues:** Tune SKILL.md descriptions patterns
...
### Iterate Patterns
- SKILL.md descriptions will need refinement
