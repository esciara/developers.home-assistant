...
3. **Activation configuration** - Trigger patterns in SKILL.md descriptions
...
**2. Configuration File** (`SKILL.md descriptions`)
- Trigger patterns for all Skills
- File path patterns
- Context definitions
- Maintained throughout phase

**See:** [Native Skill Activation](../architecture/overview.md) for complete details
...
- [Native Skill Activation](../architecture/overview.md)
...
**0.3. Create SKILL.md descriptions**
```bash
# At project root or in .claude/
touch SKILL.md descriptions
```
...
**See:** [Hook System Setup Guide](../architecture/overview.md#setup-process)
...
#### C. Add Trigger Patterns to SKILL.md descriptions
...
**See:** [SKILL.md descriptions Examples](../examples/skill-rules-examples.json)

#### D. Test Skill Activation
...
- [ ] SKILL.md descriptions contains patterns for all five Skills
- [ ] SKILL.md descriptions is valid JSON
...
- [ ] SKILL.md descriptions in project root or `.claude/`
...
- Understanding SKILL.md descriptions format
...
- ✅ SKILL.md descriptions configured for all Skills
...
### SKILL.md descriptions Syntax Errors

**Problem:** JSON parsing errors
**Solution:**
1. Validate JSON: `cat SKILL.md descriptions | jq .`
...
**Solution:**
1. Check patterns in SKILL.md descriptions match actual prompts/files
2. Test with exact pattern: "sensor" if "sensor" in patterns
3. Verify Skill name in SKILL.md descriptions matches directory name
...
**Can parallelize:** Multiple people can work on different Skills simultaneously after Skill creation is set up
...
**Testing:**
- [Skill Activation Testing](../testing/hook-activation-tests.md)
- [Skill Validation Testing](../testing/skill-validation-tests.md)

**Examples:**
- [SKILL.md descriptions Examples](../examples/skill-rules-examples.json)
