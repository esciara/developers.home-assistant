...
| Hook System (lines 73-171) | `architecture/hook-system.md` |
...
3. Read: architecture/hook-system.md (critical component)
...
2. Read: architecture/hook-system.md (setup guide)
...
### 2. Understand System
`architecture/hook-system.md` - Critical to understand first
...
2. **Understand hooks:** `plans/extension-system-workflow-optimization-v3/architecture/hook-system.md`
